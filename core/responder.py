...
def _assemble_brief(
    ...
    # Lesson context — if a lesson is active, show working version and ask for demonstration
    lesson = context.get("lesson")
    if lesson and lesson.get("active") or (lesson and not lesson.get("saved")):
...
If a lesson is active, demonstrate your understanding in how you respond — don't announce it, just show it.
""".strip()
